...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/yellow-mode-c639)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/yellow-mode-c639
```

A live public deployment of this template is available at [https://yellow-mode-c639.templates.workers.dev](https://yellow-mode-c639.templates.workers.dev)
